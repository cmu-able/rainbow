...
//
//imports
//  : importSt* // TODO: Rewrite tree {   #imports = #([IMPORTS,"IMPORTS"], #imports); }
//  ;
//
//importSt
//  : i = IMPORT
...
//
//functions
//  : function* // TODO     {   #functions = #([FUNC_LIST,"FUNC_LIST"], #functions); }
//  ;
//
//function
...
//
//tactics
//  : tactic* // TODO:     {   #tactics = #([TACTICS,"TACTICS"], #tactics); }
//  ;
//
//tactic
//@after{definedTactics.add($s.start.getText ());}
//  : TACTIC s=signature
...
//
//tacticVars
//  : (declaration SEMICOLON)* // TODO {   #tacticVars = #([VAR_LIST,"VAR_LIST"], #tacticVars); }
//  ;
//
...
//
//strategies
//  : strategy* // TODO     {   #strategies = #([STRATEGIES,"STRATEGIES"], #strategies); }
//  ;
//
//strategy
//  : STRATEGY IDENTIFIER
...
//  | forStatement
//  | whileStatement
//  | s=SEMICOLON {((CommonToken )$s).setType(EMPTY_STMT);}
//  ;
//
//compoundStatement
//  : lb=LBRACE {((CommonToken )$lb).setType(STMT_LIST);}
//    statement*
//    RBRACE
//    errorBlock?
//  ;
...
//
//declaration
//  : dataType IDENTIFIER (ASSIGN expression) (IDENTIFIER (ASSIGN expression))*
//  ;
///*
//varDefinition[t]
//  : varDeclarator[t]
//    (COMMA varDeclarator[t])*
//  ;
//
//varDeclarator[t]
//  : id=IDENTIFIER v=varInitializer[t]
//  ;
//
//varInitializer[t]
//  : (ASSIGN initializer)
...
//
//forStatement
//  : FOR LPAREN (traditionalForClause | forEachClause) RPAREN statement
//  ;
//
...
//assignmentExpression
//  : booleanExpression
//    ( (ASSIGN | PLUS_ASSIGN | MINUS_ASSIGN | STAR_ASSIGN | DIV_ASSIGN | MOD_ASSIGN) assignmentExpression)?
//  ;
//
//booleanExpression
//  : impliesExpression
...
//  : INCR unaryExpression
//  | DECR unaryExpression
//  | m=MINUS {((CommonToken )$m).setType(UNARY_MINUS);} unaryExpression
//  | p=PLUS {((CommonToken )$p).setType(UNARY_PLUS);} unaryExpression
...
//postfixExpression
//  : primaryExpression
//    (in=INCR {((CommonToken )$in).setType(POST_INCR);}
//    |de=DECR {((CommonToken )$de).setType(POST_DECR);}
//    )?
//  ;
//
//primaryExpression
...
//identifierPrimary
//  : i = IDENTIFIER
//    (lp=LPAREN {((CommonToken )$i).setType(METHOD_CALL);} argList RPAREN)?
//  ;
//
//argList
//  : expressionList?
...
//  : dataType IDENTIFIER /*{setType (PARAM);}*/
//  ;
//
//dataType
//
