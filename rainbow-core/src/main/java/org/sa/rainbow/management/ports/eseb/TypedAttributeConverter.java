...
final class TypedAttributeConverter implements TypelibJavaConversionRule {

    public TypedAttributeConverter () {
    }
    ...
    public DataValue from_java (Object value, DataType dst, TypelibJavaConverter converter)
        ...
        try {
            if ((dst == null || dst instanceof StructureDataType) && value instanceof TypedAttribute) {
                ...
                if (sdt == null) {
                    sdt = (StructureDataType )ESEBProvider.SCOPE.find ("typed_attribute_with_value");
                }
                ...
                fields.put (v, ((OptionalDataType )ESEBProvider.SCOPE.find ("opt_any")).make (null));
                ...
                fields.put (name, converter.from_java (ta.getName (), null));
                fields.put (type, converter.from_java (ta.getType (), null));
                fields.put (v, ((OptionalDataType )ESEBProvider.SCOPE.find ("any?")).make (converter.from_java (
                        ta.getValue (), null)));
                StructureDataValue sdv = sdt.make (fields);
                return sdv;
            }
