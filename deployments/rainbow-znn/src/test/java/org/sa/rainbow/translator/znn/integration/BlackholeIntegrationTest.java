package org.sa.rainbow.translator.znn.integration;
...
import org.sa.rainbow.translator.znn.gauges.BlackholeGauge;
...
public class BlackholeIntegrationTest {
    ...
    public void goodPath() throws Exception {
        ...
        RegularPatternGauge gauge = new BlackholeGauge(
                ...
                gd.modelDesc(), gd.setupParams(), new HashMap<String, IRainbowOperation>(gd.mappings())
        );
