...
public class AddServerWithTypeCmd extends SwimAcmeModelCommand<IAcmeProperty> {

  private String m_server;

	public AddServerWithTypeCmd(AcmeModelInstance model, String target, String server) {
