...
public class IncDimmerCmd extends SwimAcmeModelCommand<IAcmeProperty>{
	...
	public IncDimmerCmd(AcmeModelInstance model, String target) {
		super("incDimmer", model, target, "");
