...
public class PropertiesConfigurationSynthesizer {
	...
	public static final String BATTERYMODEL_PROPKEY = "json.batterymodel";
    ...
    public static final String MODELS_PATH = "/Users/jcamara/Dropbox/Documents/Work/projects/rainbow-alt/deployments/rainbow-brass/brass-p2-cp3/alloy/";
    ...
    static {
        ...
        DEFAULT.setProperty (PropertiesConfigurationSynthesizer.BATTERYMODEL_PROPKEY, MODELS_PATH+"ros-turtlebot.json");
