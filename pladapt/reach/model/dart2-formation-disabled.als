// change formation tactics are disabled in this model
// this is a quick change for now. The complete change should remove formation altogether
...
fact traces {
	...
	all e : TraceElement - last | let e' = next[e] | {
		...
		equals[e, e'] 
		equals[e', trace/last]
	} or 	incAltTacticStart[e, e']  or decAltTacticStart[e, e'] or goLooseTactic[e, e'] or goTightTactic[e, e']
}
...
//	!(GoLoose in e.starts) and !(GoTight in e.starts)
	// always false
	!(GoLoose in e.starts) and (GoLoose in e.starts)
}
...
pred goTightCompatible[e : TraceElement] {
	...
	// always false
	!(GoTight in e.starts) and (GoTight in e.starts)
}
