...
one sig IncDimmer, DecDimmer, AddServer, RemoveServer extends T {} // tactics with no latency
...
pred removeServerCompatible[e : TraceElement] {
	!(RemoveServer in e.starts) and !(AddServer in e.starts)
}
...
run show for exactly 3 S, exactly 2 D, 3 C, 3 CP, 3 TraceElement, 0 TP, 4 T
