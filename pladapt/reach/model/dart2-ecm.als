...
fact traces {
	...
	all e : TraceElement - last | let e' = next[e] | {
		...
		equals[e, e'] 
		equals[e', trace/last]
	} or 	((incAltTacticStart[e, e']  or decAltTacticStart[e, e'] or goLooseTactic[e, e'] or goTightTactic[e, e'] or
...
run show for exactly 3 A, exactly 2 TPIA, exactly 2 TPDA, exactly 2 F, 4 C, 4 CP, 4 TraceElement
