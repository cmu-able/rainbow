...
fact traces {
	...
	all e : TraceElement - last | let e' = next[e] | {
		...
		equals[e', trace/last]
			...
			goLooseTactic[e, e'] or goTightTactic[e, e']) and
...
run show for exactly 3 A, exactly 2 TPIA, exactly 2 TPDA, exactly 2 TPIA2, exactly 2 TPDA2, exactly 2 F, 4 C, 4 CP, 3 TraceElement
