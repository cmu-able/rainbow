...
double DeterministicThreat::getProbabilityOfDestruction(const DartConfiguration& config) {
	double effectiveRange = range;
	if (config.getFormation() == DartConfiguration::Formation::TIGHT) {
		effectiveRange = range / destructionFormationFactor;
	}
...
DeterministicThreat::~DeterministicThreat() {
