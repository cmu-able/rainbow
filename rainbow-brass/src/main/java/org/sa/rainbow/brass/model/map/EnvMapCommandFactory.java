...
public class EnvMapCommandFactory extends ModelCommandFactory<EnvMap> {
	...
	public InsertNodeCmd insertNodeCmd ( String n, String na, String nb, String x, String y) {
		return new InsertNodeCmd ((EnvMapModelInstance)m_modelInstance, "", n, na, nb, x, y);
	}
}
