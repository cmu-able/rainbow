...
public class InstructionGraphLoadCommand extends AbstractLoadModelCmd<InstructionGraphProgress> {
    ...
    public InstructionGraphLoadCommand (String modelName, IModelsManager mm, InputStream is, String source) {
    ...
    protected void subExecute () throws RainbowException {
        ...
        try {
            if (m_stream != null) {
                ...
                InstructionGraphProgress g = new InstructionGraphProgress (getModelReference ());
                m_result = new InstructionGraphModelInstance (g, getOriginalSource ());
                doPostExecute ();
            }
        }
