...
import edu.cmu.cs.able.eseb.LimitedDistributionQueue;
import edu.cmu.cs.able.eseb.LimitedDistributionQueueElement;
...
public class BusEventsFrame extends JInternalFrame {
	 ...
	 */
	private BusServerRemoteInterface m_remote;
	...
	public BusEventsFrame(String host, short port,
			BusServerRemoteInterface remote) {
